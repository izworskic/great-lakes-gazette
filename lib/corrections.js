...
export function applyArchiveCorrections(issue, date) {
  ...
  brief.correctionNote = 'Corrected September 17, 2026: the water-level paragraph now reports the archived NOAA station observations and their limits. Unsupported navigation implications were withdrawn.' + (key === '2026-09-17' ? ' The vessel spotlight, report date and ETA wording were also corrected; the unsupported distance was removed.' : '');
