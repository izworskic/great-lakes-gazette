...
10. Do NOT include the author's name anywhere in the BRIEF body. Authorship is rendered separately as a byline by the site template. Open the first sentence with the single most newsworthy vessel movement or lake condition from the data.

OUTPUT FORMAT:
HEADLINE: [6-10 words about vessel or lake conditions, never about BoatNerd]
DATELINE: [e.g. "Bay City, Mich., March 15, 2026"]
BRIEF:
[3 to 4 paragraphs, 300 to 450 words]
- Para 1: Lead with a specific vessel movement or maritime event from the data
- Para 2 to 3: Port activity, water levels, or ice/weather conditions
