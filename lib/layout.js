...
export function aboutStrip() {
  return `<div class="about-strip">The Great Lakes Gazette uses AI to assemble daily summaries from available vessel tracking (AIS), BoatNerd port reports, NOAA water levels, and National Weather Service marine forecasts. Automated editorial and source checks run before publication, but they do not guarantee accuracy or represent a personal review of each edition. Published by <a href="/chris-izworski">${AUTHOR}</a> in Bay City, Michigan, where the Saginaw River meets the bay.</div>`;
}
