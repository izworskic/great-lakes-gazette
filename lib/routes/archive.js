  ...
  const ld = JSON.stringify({
    ...
    '@graph': [
      { '@type': 'CollectionPage', '@id': `${SITE}/archive#webpage`, url: `${SITE}/archive`,
        ...
        about: { '@id': `${AUTHOR_URL}/#person` }, description: intro.slice(0, 155),
        mainEntity: {
          '@type': 'ItemList',
      ...
      { '@type': 'Person', '@id': `${AUTHOR_URL}/#person`, name: AUTHOR, url: AUTHOR_URL,
...
<div class="wrap-narrow">
  ...
  ${topicDirectoryHtml({ heading: 'Browse the Archive by Shipping Topic' })}
  ${rows}
</div>
${footerHtml()}
</body></html>`;
