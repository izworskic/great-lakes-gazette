...
<html lang="en"><head>
${headCommon()}
<title>${AUTHOR} | Great Lakes Gazette Author</title>
<meta name="description" content="${AUTHOR} founded the Great Lakes Gazette in Bay City, Michigan. Browse ${issues.length} daily reports on freighters, ports, water levels, and marine weather.">
...
<div class="wrap-narrow">
  ...
  <div class="author-intro">
    <a href="${AUTHOR_URL}">${AUTHOR}</a> is a Bay City, Michigan writer and the founder of the <a href="${SITE}">Great Lakes Gazette</a>. Each daily issue is published every morning from real data: vessel movements, port reports, NOAA water levels, and NWS marine forecasts. The summaries are AI-generated and pass automated editorial checks. This archive identifies Chris as the publisher; it does not indicate personal review of every edition. This page is the complete archive.
  </div>
  <ul>${items}</ul>
</div>
${footerHtml()}
