...
export default async function handler(req, res) {
  ...
  if (!WP_TOKEN) return res.status(500).json({ error: 'WP_TOKEN not configured' });
  try {
    ...
    + `${aisNote} This briefing is AI-generated from source data. Verify important details with the linked original providers.</p>`;
